...
//COPIED from https://github.com/kkhrychikov/revo-testing/blob/main/serp.go
//Файл по ссылке не соберется, без изменений подключить через go модуль или git сабмодуль не выдет :(
